...
function Home() {
  useEffect(() => {
    ...
    function showStep(idx) {
      ...
      allIds.forEach(id => document.getElementById(id)?.classList.remove('show'));
...
Pancake<br />Mansion
  ...
  <p className="hero-sub">Håndlavede mini pandekager — lagvis opbygget med kærlighed og de bedste toppings.</p>
  ...
  <div className="sticky-stage">
    <div className="stage-layout">
      ...
      <div className="pancake-scene">
        ...
        <div className="progress-ring">
          <svg viewBox="0 0 376 376">
            <circle id="ring" cx="188" cy="188" r="184"
              strokeDasharray="1156" strokeDashoffset="1156"/>
          </svg>
        </div>
 
        <svg id="pancake-svg" viewBox="0 0 400 420" xmlns="http://www.w3.org/2000/svg">
          <defs>
            <radialGradient id="panGrad" cx="42%" cy="38%" r="60%" gradientUnits="objectBoundingBox">
            ...
            <radialGradient id="rimGrad" cx="50%" cy="50%" r="50%" gradientUnits="objectBoundingBox">
              <stop offset="68%"  stopColor="transparent"/>
              <stop offset="100%" stopColor="#6A380Acc"/>
            </radialGradient>
            <radialGradient id="hiGrad" cx="40%" cy="34%" r="38%" gradientUnits="objectBoundingBox">
          ...
          {/*Drop shadow*/}
          <ellipse cx="202" cy="350" rx="155" ry="22" fill="url(#shadowGrad)" opacity="0.5"/>
          {/*Side edge*/}
          <ellipse cx="200" cy="214" rx="180" ry="118" fill="#7A430F"/>
          {/*Top surface*/}
          <ellipse cx="200" cy="205" rx="180" ry="118" fill="url(#panGrad)"/>
          <ellipse cx="200" cy="205" rx="180" ry="118" fill="url(#rimGrad)"/>
          <ellipse cx="200" cy="205" rx="180" ry="118" fill="url(#hiGrad)"/>
          ...
          <g clipPath="url(#panClip)">
            ...
            <g id="t-dark" className="top-group">
              <path d="M55,198 Q120,152 180,195 Q240,238 298,180 Q328,152 340,200"
                    fill="none" stroke="#1E0E06" strokeWidth="12" strokeLinecap="round" opacity="0.80"/>
              <path d="M70,238 Q140,205 200,242 Q252,275 330,238"
                    fill="none" stroke="#1E0E06" strokeWidth="8"  strokeLinecap="round" opacity="0.50"/>
              <path d="M110,148 Q162,122 200,148 Q238,174 282,142"
                    fill="none" stroke="#1E0E06" strokeWidth="7"  strokeLinecap="round" opacity="0.40"/>
            </g>
 
            {/*Step 1b · White chocolate drizzle*/}
            <g id="t-white" className="top-group">
              <path d="M75,172 Q140,130 200,172 Q260,214 325,172"
                    fill="none" stroke="#F9E4B7" strokeWidth="8" strokeLinecap="round" opacity="0.88"/>
              <path d="M95,252 Q158,222 210,258 Q252,286 308,256"
                    fill="none" stroke="#F9E4B7" strokeWidth="6" strokeLinecap="round" opacity="0.65"/>
            </g>
            ...
            <g id="t-banana" className="top-group">
              <g transform="translate(98 174)">
                ...
                <circle cx="-5" cy="-5" r="7" fill="#FDF07A" opacity="0.55"/>
            ...
            <g id="t-blue" className="top-group">
              <g transform="translate(166 190)">
                ...
                <circle cx="-5" cy="-5" r="5" fill="#6A5EC8" opacity="0.55"/>
              </g>

              <g transform="translate(218 184)">
                <circle r="11" fill="#3B2E8A"/>
                <circle cx="-4" cy="-4" r="4" fill="#6A5EC8" opacity="0.55"/>
              </g>
            ...
            <g id="t-oreo" className="top-group">
              <g transform="translate(116 146) rotate(-18)">
                <rect x="-28" y="-10" width="56" height="20" rx="6" fill="#130A06"/>
                <rect x="-23" y="-6" width="46" height="12" rx="4" fill="none" stroke="#2E1A0E" strokeWidth="1.4"/>
                <rect x="-14" y="-3" width="28" height="6" rx="2" fill="none" stroke="#2E1A0E" strokeWidth="1"/>
              </g>
              ...
              <g transform="translate(204 288) rotate(-4)">
                <rect x="-30" y="-10" width="60" height="20" rx="6" fill="#130A06"/>
                <rect x="-25" y="-6" width="50" height="12" rx="4" fill="none" stroke="#2E1A0E" strokeWidth="1.4"/>
                <rect x="-15" y="-3" width="30" height="6" rx="2" fill="none" stroke="#2E1A0E" strokeWidth="1"/>
              </g>
            </g>
          </g>
        </svg>
      ...
      <div className="text-panel" id="text-panel">
        <div className="step-label" id="step-label">Trin 1</div>
        <div className="step-title" id="step-title">Den perfekte bund</div>
        <div className="step-desc"  id="step-desc">Tre luftige mini pandekager, gyldne og bløde — bagt til perfektion med sprøde kanter og et blødt hjerte. Alt godt starter her.</div>
...
<section className="cta-section">
  <h2 className="cta-title">Dit næste<br />favorit øjeblik.</h2>
  <p className="cta-body">Pancake Mansion er skabt til dem der ved, at det bedste i livet kommer i små, søde bidder. Lad dig friste.</p>
  <Link to="/find-os" className="cta-btn">Find os nu</Link>
</section>
